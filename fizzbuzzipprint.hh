...
FizzBuzzIPPrint([LABEL, I<KEYWORDS>])
...
=a Print, CheckIPHeader (FizzBuzz) */

class FizzBuzzIPPrint : public Element { public:

  FizzBuzzIPPrint() CLICK_COLD;
  ~FizzBuzzIPPrint() CLICK_COLD;

  const char *class_name() const		{ return "FizzBuzzIPPrint"; }
